---
title: "Análisis de la adopción de Tecnologías 4.0 en SEDEMI"
author: "David Calderón"
...
```{r boxplot-indice, echo=FALSE, fig.cap="Indice de madurez tecnologica 4.0"}
ggplot(enc_diag, aes(y = Indice_Madurez_Tec)) +
  geom_boxplot() +
